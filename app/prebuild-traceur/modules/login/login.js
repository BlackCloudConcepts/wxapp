...
$traceurRuntime.ModuleStore.getAnonymousModule(function() {
  ...
  'use strict';
  (function() {
    angular.module('wxApp.modules.login', ['ngRoute', 'firebase', 'wxApp.directivemodules.footer']).config(['$routeProvider', function($routeProvider) {
      $routeProvider.when('/login', {templateUrl: 'modules/login/login.html'});
    }]).controller('LoginController', LoginController).service('FirebaseService', FirebaseService);
...
//# sourceURL=app/modules/login/login.js