...
$traceurRuntime.ModuleStore.getAnonymousModule(function() {
  ...
  'use strict';
  (function() {
    angular.module('wxApp.modules.logout', ['ngRoute']).config(['$routeProvider', function($routeProvider) {
      $routeProvider.when('/logout', {templateUrl: 'modules/logout/logout.html'});
...
//# sourceURL=app/modules/logout/logout.js