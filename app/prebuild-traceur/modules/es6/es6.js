...
$traceurRuntime.ModuleStore.getAnonymousModule(function() {
  ...
  'use strict';
  (function() {
    angular.module('wxApp.modules.es6', ['ngRoute', 'wxApp.directivemodules.footer']).config(['$routeProvider', function($routeProvider) {
      $routeProvider.when('/es6', {templateUrl: 'modules/es6/es6.html'});
...
//# sourceURL=app/modules/es6/es6.js